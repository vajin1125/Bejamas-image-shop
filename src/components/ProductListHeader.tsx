...
function ProductListHeader() {
	...
	const sortAlphabetically = () => {
		if (isAscending === false) {
			productsCurrent.sort((a:any, b:any) => a.name.localeCompare(b.name))
			setIsAscending(true)
		}

		if (isAscending === true) {
			productsCurrent.sort((a:any, b:any) => b.name.localeCompare(a.name))
	...
	const sortByPrice = () => {
		if (isSortByPrice === false) {
			productsCurrent.sort((a:any, b:any) => a.price - b.price)
			setIsSortByPrice(true)
		}

		if (isSortByPrice === true) {
			productsCurrent.sort((a:any, b:any) => b.price - a.price)
